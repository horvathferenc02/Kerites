<template>
  <div id="app">
    <b-navbar toggleable="lg" type="primary" variant="dark">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <b-nav-item href="https://github.com/horvathferenc02/KeritesErettsegiVue">GitHub</b-nav-item>
          <b-nav-item href="https://github.com/nitslaszlo/ErettsegiKeritesTsVueJs">Alap feldat</b-nav-item>
        </b-navbar-nav>
      </b-collapse>
    </b-navbar>
    <TxtReader label="Forrás (kerites.txt):" placeholder="Fájl kiválasztása..." @load="txtSorai = $event" />
    <div v-if="mutat" id="megoldas" class="w-25 p-3 mb-1 bg-secondary text-light">
    ...
    <div v-if="mutat" id="egyebek">
      <pre class="w-400 p-3 mb-1 bg-secondary text-light">
utcakep.txt fájl:
{{ utcakep }}
      </pre>
